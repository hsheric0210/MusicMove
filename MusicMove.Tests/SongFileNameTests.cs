...
{
    public class SongFileNameTests
    {
        [Fact]
        public void ParseFileName_ParseSuccess_Normalized()
        {
            ...
            var actual = SongFileName.ParseFileName("a, b, c, d & e - abcdefg (ft. acbd, efgh & foobar)");
        ...
        {
            var expected = new Music.FileNameInfo(new string[] { "a", "b", "c", "d", "e" }, "abcdefg", new string[] { "acbd", "efgh", "foobar" }, "", "");
            var actual = SongFileName.ParseFileName("a, b, c, d & e (ft. acbd, efgh & foobar) - abcdefg");
            Assert.Equal(expected.Artists, actual.Artists);
            Assert.Equal(expected.SongName, actual.SongName);
            Assert.Equal(expected.Featuring, actual.Featuring);
        }
        ...
        {
            var expected = new Music.FileNameInfo(new string[] { "a", "b", "c", "d", "e" }, "abcdefg", new string[] { "acbd", "efgh", "foobar" }, "", "");
            var actual = SongFileName.ParseFileName("a, b, c, d & e - abcdefg ft. acbd, efgh & foobar (remix)");
            Assert.Equal(expected.Artists, actual.Artists);
            Assert.Equal(expected.SongName, actual.SongName);
            Assert.Equal(expected.Featuring, actual.Featuring);
        }
        ...
        {
            var expected = new Music.FileNameInfo(new string[] { "a", "b", "c", "d", "e" }, "abcdefg", new string[] { "acbd", "efgh", "foobar" }, "", "");
            var actual = SongFileName.ParseFileName("a, b, c, d & e - abcdefg ft. acbd, efgh & foobar [release]");
            Assert.Equal(expected.Artists, actual.Artists);
            Assert.Equal(expected.SongName, actual.SongName);
            Assert.Equal(expected.Featuring, actual.Featuring);
        }
        ...
        public void ParseFileName_ParseSuccess_RemixTag_Single()
        {
            ...
            var actual = SongFileName.ParseFileName("a, b, c, d & e - abcdefg ft. acbd, efgh & foobar (remix by A)");
            Assert.Equal(expected.Artists, actual.Artists);
            Assert.Equal(expected.SongName, actual.SongName);
            Assert.Equal(expected.Featuring, actual.Featuring);
        ...
        public void ParseFileName_ParseSuccess_RemixTag_Multiple()
        {
            ...
            var actual = SongFileName.ParseFileName("a, b, c, d & e - abcdefg ft. acbd, efgh & foobar (remix by A) (remix by B) (remix by C)");
            Assert.Equal(expected.Artists, actual.Artists);
            Assert.Equal(expected.SongName, actual.SongName);
            Assert.Equal(expected.Featuring, actual.Featuring);
            Assert.Equal(expected.RemixTag, actual.RemixTag);
        ...
        public void ParseFileName_ParseSuccess_ReleaseTag_Single()
        {
            ...
            var actual = SongFileName.ParseFileName("a, b, c, d & e - abcdefg ft. acbd, efgh & foobar [release by A]");
            Assert.Equal(expected.Artists, actual.Artists);
            Assert.Equal(expected.SongName, actual.SongName);
            Assert.Equal(expected.Featuring, actual.Featuring);
        ...
        public void ParseFileName_ParseSuccess_ReleaseTag_Multiple()
        {
            ...
            var actual = SongFileName.ParseFileName("a, b, c, d & e - abcdefg ft. acbd, efgh & foobar [release by A] [release by B] [release by C]");
            Assert.Equal(expected.Artists, actual.Artists);
            Assert.Equal(expected.SongName, actual.SongName);
            Assert.Equal(expected.Featuring, actual.Featuring);
            Assert.Equal(expected.ReleaseTag, actual.ReleaseTag);
        ...
        public void ParseFileName_ParseSuccess_RemixAndReleaseTag_Complex()
        {
            ...
            var actual = SongFileName.ParseFileName("a, b, c, d & e - abcdefg ft. acbd, efgh & foobar (remix by A) (remix by B) (remix by C) [release by A] [release by B] [release by C]");
            Assert.Equal(expected.Artists, actual.Artists);
            Assert.Equal(expected.SongName, actual.SongName);
            Assert.Equal(expected.Featuring, actual.Featuring);
            Assert.Equal(expected.RemixTag, actual.RemixTag);
        ...
        public void ParseFileName_ParseSuccess_RemixAndReleaseTag_Complex_NoFeaturing()
        {
            ...
            var actual = SongFileName.ParseFileName("a, b, c, d & e - abcdefg (remix by A) (remix by B) (remix by C) [release by A] [release by B] [release by C]");
            Assert.Equal(expected.Artists, actual.Artists);
            Assert.Equal(expected.SongName, actual.SongName);
            Assert.Equal(expected.Featuring, actual.Featuring);
            Assert.Equal(expected.RemixTag, actual.RemixTag);
        ...
        {
            var expected = new Music.FileNameInfo(new string[] { "a", "b", "c", "d", "e" }, "abcdefg", new string[] { "acbd", "efgh", "foobar" }, "(remix by A) (remix by B) (remix by C)", "[release by A] [release by B] [release by C]");
            var actual = SongFileName.ParseFileName("a, b, c, d & e ft. acbd - abcdefg (feat. efgh & foobar) (remix by A) (remix by B) (remix by C) [release by A] [release by B] [release by C]");
            Assert.Equal(expected.Artists, actual.Artists);
            Assert.Equal(expected.SongName, actual.SongName);
            Assert.Equal(expected.Featuring, actual.Featuring);
            Assert.Equal(expected.RemixTag, actual.RemixTag);
        ...
        {
            Assert.Throws<FormatException>(() => _ = SongFileName.ParseFileName("a, b, c, d & e _ abcdefg (ft. abcdefgh)"));
        }
        ...
        public void GetNormalizedName_MessedUp()
        {
            ...
            var actual = SongFileName.GetNormalizedFileName(SongFileName.ParseFileName("a x b X c & d, e (ft. alpha x beta & gamma) - abcdefg (feat. delta X omikron) (Nightcore Mix) (REReRemix) [NCS Release] [Monstercat Release]"));
        ...
        public void GetNormalizedName_CompoundArtists()
        {
            ...
            var actual = SongFileName.GetNormalizedFileName(SongFileName.ParseFileName("zeus x crona (ft. alpha x beta & gamma) - abcdefg (feat. delta X omikron) (Nightcore Mix) (REReRemix) [NCS Release] [Monstercat Release]"));
            Assert.Equal(expected, actual);
        }
